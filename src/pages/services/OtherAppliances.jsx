...
import { PiWrenchLight, PiShieldCheckLight, PiClockLight, PiThermometerLight, PiGearLight, PiLightningLight, PiHouseLight } from 'react-icons/pi';
...
const OtherAppliances = () => {
  ...
  const features = [
    { title: "General Fix", desc: "Repairing common electrical and mechanical issues for all home devices.", icon: <PiHouseLight /> },
    { title: "Wiring Repair", desc: "Fixing internal circuits and power cables for safe operation.", icon: <PiLightningLight /> },
    { title: "Part Replace", desc: "Replacing faulty components with high-quality compatible parts.", icon: <PiGearLight /> },
    { title: "Safety Check", desc: "Rigorous testing to ensure your appliance is safe for family use.", icon: <PiShieldCheckLight /> }
  ];

  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      <Helmet>
        <title>Other Appliance Repair | Fast & Honest Service | Mister Appliance</title>
        <meta name="description" content="Need help with a different appliance? We repair all kinds of household machines with original parts and honesty." />
      </Helmet>
      ...
      <section className="relative pt-44 pb-32 bg-slate-50/50 overflow-hidden text-center">
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-slate-900 mb-8 leading-tight tracking-tighter">
            Other Appliance <span className="text-amber-500 underline decoration-slate-200 underline-offset-8 italic">Repair.</span>
          </h1>
          <p className="text-slate-500 text-lg md:text-xl font-medium max-w-3xl mx-auto leading-relaxed">
            From mixers to air purifiers, we provide quick and honest repair for all types of home machines at your doorstep.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="relative group">
              ...
              <div className="rounded-[2.5rem] overflow-hidden border-8 border-white shadow-2xl relative z-10">
                <img src="/banner/hero-1.jpg" className="w-full h-[500px] md:h-[650px] object-cover transition-transform duration-1000 group-hover:scale-105" alt="Appliance Repair" />
              </div>
            </div>
            ...
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-slate-900 leading-[1.1] tracking-tighter">
                  Universal Solutions for <br/>
                  <span className="text-amber-500 italic">Every Device.</span>
                </h2>
              </div>
              <p className="text-slate-500 text-lg md:text-xl font-medium leading-relaxed max-w-xl">
                We handle electrical issues, motor failure, and general wear and tear with ease. We only use high-quality parts to make sure your machine works perfectly for a long time.
              </p>
              <div className="grid gap-5">
                {["Same-day visits for urgent repairs", "High-quality parts with guarantee", "Fair and honest pricing always", "Friendly workers you can trust"].map((item, index) => (
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-center gap-8">
                <button onClick={() => openBookingModal('Other Appliance')} className="group w-full sm:w-auto inline-flex items-center justify-center gap-4 px-12 py-5 bg-slate-900 text-white rounded-2xl font-black uppercase tracking-widest text-[11px] hover:bg-amber-400 hover:text-black transition-all shadow-xl active:scale-95">
      ...
      <section className="py-24 bg-slate-50/50">
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="text-center max-w-3xl mx-auto mb-20 space-y-6">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6 tracking-tight">Multi-appliance specialists.</h2>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="bg-slate-900 rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10 space-y-10">
              <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-white leading-tight tracking-tight">Is Your Device Broken? <br /><span className="text-amber-400 italic">Let Us Fix It Fast.</span></h2>
              <div className="flex justify-center relative z-10">
                <button onClick={() => openBookingModal('Other Appliance')} className="group inline-flex items-center gap-4 px-12 py-5 bg-amber-400 text-black rounded-2xl font-black uppercase tracking-widest text-[12px] hover:bg-white transition-all duration-500 shadow-xl shadow-amber-400/20 active:scale-95">Schedule Repair Now <FiArrowLeft className="group-hover:-translate-x-2 transition-transform rotate-180" /></button>
              </div>
