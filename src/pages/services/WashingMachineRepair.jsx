...
import { PiWrenchLight, PiShieldCheckLight, PiClockLight, PiDropLight, PiGearLight, PiLightningLight } from 'react-icons/pi';
...
const WashingMachineRepair = () => {
  ...
  const features = [
    {
      title: "Motor Fix",
      desc: "Repairing or replacing motors to make your machine spin smoothly again.",
      icon: <PiGearLight />
    },
    {
      title: "No More Leaks",
      desc: "Stopping water leakage and fixing drainage issues quickly.",
      icon: <PiDropLight />
    },
    {
      title: "PCB Repair",
      desc: "Expert fix for digital display and control board problems.",
      icon: <PiLightningLight />
    },
    {
      title: "Clean Drum",
      desc: "Removing dirt and smells to keep your clothes fresh and clean.",
  ...
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      <Helmet>
        <title>Washing Machine Repair | Fast & Honest Service | Mister Appliance</title>
        <meta name="description" content="Get your washing machine fixed today. We repair all top-load and front-load brands with original parts and honesty." />
      </Helmet>
      ...
      <section className="relative pt-44 pb-32 bg-slate-50/50 overflow-hidden text-center">
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-slate-900 mb-8 leading-tight tracking-tighter">
            Washing Machine <span className="text-amber-500 underline decoration-slate-200 underline-offset-8">Repair.</span>
          </h1>
          <p className="text-slate-500 text-lg md:text-xl font-medium max-w-3xl mx-auto leading-relaxed">
            Don't let dirty laundry pile up. We provide quick and honest repair for all types of washing machines at your home.
          </p>
        </div>
      </section>

      {/* Main Detail Section - Clean Split Layout */}
      <section className="py-24 bg-white relative z-20">
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">

            {/* Left side: Clean Visual Frame */}
            ...
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-slate-900 leading-[1.1] tracking-tighter">
                  ...
                  <span className="text-amber-500 italic">Every Brand.</span>
                </h2>
              </div>

              <p className="text-slate-500 text-lg md:text-xl font-medium leading-relaxed max-w-xl">
                Whether it's a front-load or top-load machine, our skilled team can fix it. We handle motor issues, water leaks, and digital errors with ease. We only use original factory parts to make sure your machine works perfectly for a long time.
              </p>
              ...
              <div className="grid gap-5">
                {[
                  ...
                  "Fair and honest pricing always",
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-center gap-8">
                <button 
                  ...
                  className="group w-full sm:w-auto inline-flex items-center justify-center gap-4 px-12 py-5 bg-slate-900 text-white rounded-2xl font-black uppercase tracking-widest text-[11px] hover:bg-amber-400 hover:text-black transition-all shadow-xl active:scale-95"
                >
                ...
                <div className="flex items-center gap-4">
                   ...
                   <div>
                      ...
                      <p className="text-sm font-bold text-slate-900 italic">Under 120 Mins</p>
                   </div>
                </div>
              </div>
            </div>
      ...
      {/* Features Grid Section - Clean Tiles */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((v, i) => (
              <div key={i} className="bg-white p-10 rounded-[2.5rem] border border-slate-100 flex flex-col items-center text-center group hover:border-amber-400 hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-500">
                <div className="w-16 h-16 rounded-3xl bg-slate-50 text-slate-400 flex items-center justify-center text-3xl mb-8 group-hover:bg-amber-400 group-hover:text-black transition-all duration-500 shadow-sm">
                  {v.icon}
                </div>
          ...
          <div className="bg-slate-900 rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10 space-y-10">
              <h2 className="text-3xl md:text-5xl font-bold text-white leading-tight tracking-tight">
                Is Your Machine Leaking? <br />
                <span className="text-amber-400 italic">Let Us Fix It Fast.</span>
              </h2>
              ...
              <div className="flex justify-center relative z-10">
                ...
                >
                  Schedule Repair Now <FiArrowLeft className="group-hover:-translate-x-1 transition-transform rotate-180" />
                </button>
              </div>
