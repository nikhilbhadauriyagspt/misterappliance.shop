...
import { PiWrenchLight, PiShieldCheckLight, PiClockLight, PiThermometerLight, PiGearLight, PiLightningLight, PiTimerLight } from 'react-icons/pi';
...
const MicrowaveOvenRepair = () => {
  ...
  const features = [
    { title: "Magnetron Fix", desc: "Repairing the heating core to ensure even and fast cooking.", icon: <PiThermometerLight /> },
    { title: "Turntable Fix", desc: "Fixing rotating plate issues for consistent heating results.", icon: <PiGearLight /> },
    { title: "PCB Repair", desc: "Expert fix for digital display and touch panel problems.", icon: <PiLightningLight /> },
    { title: "Timer Repair", desc: "Repairing or replacing faulty timers and door sensors.", icon: <PiTimerLight /> }
  ];

  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      <Helmet>
        <title>Microwave Oven Repair | Fast & Honest Service | Mister Appliance</title>
        <meta name="description" content="Get your microwave fixed today. We repair all solo, grill and convection brands with original parts and honesty." />
      </Helmet>
      ...
      <section className="relative pt-44 pb-32 bg-slate-50/50 overflow-hidden text-center">
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-slate-900 mb-8 leading-tight tracking-tighter">
            Microwave <span className="text-amber-500 underline decoration-slate-200 underline-offset-8 italic">Repair.</span>
          </h1>
          <p className="text-slate-500 text-lg md:text-xl font-medium max-w-3xl mx-auto leading-relaxed">
            From heating issues to sparking, we provide quick and honest repair for all microwave brands at your doorstep.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="relative group">
              ...
              <div className="rounded-[2.5rem] overflow-hidden border-8 border-white shadow-2xl relative z-10">
                <img src="/service-8.jpg" className="w-full h-[500px] md:h-[650px] object-cover transition-transform duration-1000 group-hover:scale-105" alt="Microwave Oven Repair" />
              </div>
            </div>
            ...
            <div className="space-y-10">
              <div className="space-y-6">
                ...
                <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-slate-900 leading-[1.1] tracking-tighter">
                  Perfect Heating for <br/>
                  <span className="text-amber-500 italic">Every Meal.</span>
                </h2>
              </div>
              <p className="text-slate-500 text-lg md:text-xl font-medium leading-relaxed max-w-xl">
                We handle magnetron issues, turntable failure, and sparking with ease. We only use original factory parts to make sure your microwave works perfectly for a long time.
              </p>
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-center gap-8">
                <button onClick={() => openBookingModal('Microwave Oven')} className="group w-full sm:w-auto inline-flex items-center justify-center gap-4 px-12 py-5 bg-slate-900 text-white rounded-2xl font-black uppercase tracking-widest text-[11px] hover:bg-amber-400 hover:text-black transition-all shadow-xl active:scale-95">
      ...
      <section className="py-24 bg-slate-50/50">
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="text-center max-w-3xl mx-auto mb-20 space-y-6">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6 tracking-tight">Microwave specialists.</h2>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="bg-slate-900 rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl">
            ...
            <div className="relative z-10 space-y-10">
              <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-white leading-tight tracking-tight">Is Your Microwave Sparking? <br /><span className="text-amber-400 italic">Let Us Fix It Fast.</span></h2>
              <div className="flex justify-center relative z-10">
                <button onClick={() => openBookingModal('Microwave Oven')} className="group inline-flex items-center gap-4 px-12 py-5 bg-amber-400 text-black rounded-2xl font-black uppercase tracking-widest text-[12px] hover:bg-white transition-all duration-500 shadow-xl shadow-amber-400/20 active:scale-95">Schedule Repair Now <FiArrowLeft className="group-hover:-translate-x-1 transition-transform rotate-180" /></button>
              </div>
